...
namespace HelloBees\Production\Domain\Exception;

use HelloBees\SharedKernel\Domain\Exception\DomainException;
use HelloBees\SharedKernel\Domain\ValueObject\Identity\Uuid;
use Throwable;

final class HarvestNotFoundException extends DomainException
{
    ...
    {
        return new self('Harvest not found', ['uuid' => (string) $uuid]);
    }
}
