...
namespace HelloBees\History\Domain\Exception;

use HelloBees\SharedKernel\Domain\Exception\DomainException;
use HelloBees\SharedKernel\Domain\ValueObject\Identity\Uuid;
use Throwable;

final class TraceNotFoundException extends DomainException
{
    ...
    {
        return new self('Trace not found', ['uuid' => (string) $uuid]);
    }
}
